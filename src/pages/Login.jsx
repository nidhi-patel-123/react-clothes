                    ...
                    <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-md m-auto gap-y-5'>
                        ...
                        {currState === "Sign Up" && (
                            <div className='w-full'>
                                ...
                                <input onChange={(e) => setName(e.target.value)} value={name} type="text" placeholder='Name' className='w-full px-3 py-1.5 ring-1 ring-slate-900/10 rounded bg-primary mt-1' required />
                            </div>
                        )}
                        <div className='w-full'>
                            <label htmlFor='email' className='medium-15'>Email</label>
                            <input onChange={(e) => setEmail(e.target.value)} value={email} type="text" placeholder='email' className='w-full px-3 py-1.5 ring-1 ring-slate-900/10 rounded bg-primary mt-1' required />
                        </div>
                        <div className='w-full'>
