              ...
              <div className='flex flex-col gap-1 rounded-lg p-4 bg-white'>
                <div className='flexBetween'>
                  <div className='flexCenter gap-x-2'>
                    <img src={user1} alt="useimg" height={44} width={44} className='rounded-full' />
                ...
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic delectus iusto nulla optio, dignissimos aut. At nobis, rerum molestias illo, fugiat dolor minima aliquid cupiditate, a magni impedit. Eos, quas?</p>
                <div className='flex gap-x-1 mt-5'>
                  <img src={product1} alt="product1img" height={44} width={44} className='rounded aspect-square object-cover' />
                  <img src={product2} alt="product1img" height={44} width={44} className='rounded aspect-square object-cover' />
                </div>
              </div>
               <div className='flex flex-col gap-1 rounded-lg p-4 bg-white'>
                <div className='flexBetween'>
                  <div className='flexCenter gap-x-2'>
                    <img src={user2} alt="useimg" height={44} width={44} className='rounded-full' />
                    <h5 className='bold-14'>jalebi patil</h5>
                  </div>
                  <div className='bg-secondary text-white rounded-full flexCenter gap-x-2 p-1 px-2 text-xs font-semibold'>
                    <FaCheck/>
                    Verified
                ...
                <h4 className='h4 '>best design</h4>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic delectus iusto nulla optio, dignissimos aut. At nobis, rerum molestias illo, fugiat dolor minima aliquid cupiditate, a magni impedit. Eos, quas?</p>
                <div className='flex gap-x-1 mt-5'>
                  <img src={product3} alt="product1img" height={44} width={44} className='rounded aspect-square object-cover' />
                  <img src={product4} alt="product1img" height={44} width={44} className='rounded aspect-square object-cover' />
                </div>
              </div>
