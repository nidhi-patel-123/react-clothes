...
function Hero() {
  return (
    <section className='max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[700px] w-full mb-10 relative'>
<div className='bg-white p-3 rounded-2xl max-w-[233px] relative top-8 xl:top-12'>
  ...
  <p className='text-[13px]'><b className='uppercase'>Unlock</b>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates modi obcaecati quidem hic architecto natus!</p>
</div>
<div className='mt-12 sm:mt-20 xl:mt-40 max-w-[777px]'>
  ...
  <h1 className='h1 font-[500] capitalize '>Every Clik brings you Closer to perfect shop now!</h1>
  <div className='flex '>
    <Link className='bg-white text-xs font-medium pl-5 rounded-full flexCenter gap-x-2 group'>
    Check Our Modern Collection
    <FaArrowRight className='text-white bg-secondary rounded-full h-11 w-11 p-3 m-[3px] border border-white group-hover:-rotate-[20deg] transition-all duration-500'/>
    </Link>
  </div>
</div>
    </section>
