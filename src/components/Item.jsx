...
function Item({ product }) {
    return (
        <div className='botton-12 relative'>
            {/* img */}
            <Link to={`/product/${product._id}`} className='flexContainer relative top-12  overflow-hidden m-2.5'>
                <img src={product.image[0]} alt="productimg" className='rounded-xl' />
            </Link>
            {/* info */}
